      ...
      <section className="contact-hero">
        <div className="container">
          ...
          <p className="section-subtitle">
            Ada pertanyaan atau ingin buat janji servis? Kami siap membantu Anda
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="stats-grid">
            {contactCards.map((card) => (
              <div key={card.title} className="stat-card contact-info-card">
        ...
        <div className="container">
          <div className="contact-layout">
            ...
            <div className="contact-form-wrap">
              <h2 className="contact-section-heading">Kirim Pesan</h2>
              <p className="contact-section-sub">
                Isi formulir di bawah ini dan kami akan merespons dalam 1×24 jam
              </p>
            ...
            <aside className="contact-aside">
              <div className="contact-aside-block">
                ...
                <p>
                  Hubungi langsung tim kami melalui WhatsApp untuk respons lebih
              ...
              <div className="contact-aside-block">
                ...
                <p>Tersedia parkir luas &amp; ruang tunggu nyaman</p>
              </div>
